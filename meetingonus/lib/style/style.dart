...
final primary = const Color(0xFF0985B5);
final secondary = const Color(0xFFF2B82A);
...
TextStyle subTitleWhiteSansRegular() {
...
TextStyle subTitleWhite2SansRegular() {
  return new TextStyle(
...
TextStyle subTitleWhiteUnderline2SansRegular() {
  return new TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 14.0,
    color: Colors.white,
...
TextStyle smallAddressWhiteSansRegular() {
  return new TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 12.0,
    color: Colors.white,
...
TextStyle smallAddressWhite2SansRegular() {
  return new TextStyle(
    fontWeight: FontWeight.w600,
    fontSize: 12.0,
...
TextStyle smallAddressGreySansRegular() {
  return new TextStyle(
    fontWeight: FontWeight.w600,
    fontSize: 12.0,
    color: grey,
...
TextStyle categoryWhiteSansRegular() {
  return new TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 15.0,
    color: Colors.white,
